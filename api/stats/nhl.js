...
async function fetchTeamStats(abbr, standings) {
  try {
    ...
    return {
      ...
      goalDifferentialPct: team.goalDifferentialPctg?.toFixed(3),
  ...
  try {
    ...
    return res.status(200).json({
      ...
      home:{
        ...
        last5:homeForm?.last5,
        last3:homeForm?.last3,
        avgGF_L5:homeForm?.avgGF_L5,
        avgGA_L5:homeForm?.avgGA_L5,
      ...
      away:{
        ...
        last5:awayForm?.last5,
        last3:awayForm?.last3,
        avgGF_L5:awayForm?.avgGF_L5,
        avgGA_L5:awayForm?.avgGA_L5,
