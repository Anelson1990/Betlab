        ...
        <div style={{maxWidth:680,margin:'0 auto',padding:'20px 16px 80px'}}>
          ...
          {editingGroqBankroll&&(
            <div style={{background:"rgba(139,92,246,0.05)",border:"1px solid #8b5cf644",borderRadius:14,padding:14,marginBottom:14}}>
              ...
              <div style={{display:"flex",gap:6}}>
                <button onClick={()=>{
                  const val = parseFloat(groqBankrollInput);
                  if (!val||isNaN(val)) { alert('Enter a valid number'); return; }
                  setState(s=>({...s,groqBankroll:val}));
                  setEditingGroqBankroll(false);
                  setGroqBankrollInput('');
                }} style={{flex:1,background:"#8b5cf6",border:"none",borderRadius:6,color:"#fff",padding:"6px 10px",cursor:"pointer",fontSize:11,fontWeight:700}}>SET</button>
